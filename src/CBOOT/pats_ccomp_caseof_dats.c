...
/*
// /home/hwxi/research/Postiats/git/src/pats_ccomp_caseof.dats: 2165(line=82, offs=3) -- 2769(line=111, offs=4)
*/
ATSglobaldec()
ats_void_type
...
if (((ats_sum_ptr_type)tmp7)->tag != 26) { ats_caseof_failure_handle ("/home/hwxi/research/Postiats/git/src/pats_ccomp_caseof.dats: 2230(line=85, offs=5) -- 2277(line=86, offs=40)") ; }
