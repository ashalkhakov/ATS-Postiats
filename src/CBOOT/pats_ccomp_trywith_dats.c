...
if (((ats_sum_ptr_type)tmp3)->tag != 53) { ats_caseof_failure_handle ("/home/hwxi/Research/Postiats/git/src/pats_ccomp_trywith.dats: 1818(line=63, offs=5) -- 1871(line=64, offs=43)") ; }
