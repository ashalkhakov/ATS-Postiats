...
static
ats_void_type prerr_interror_02052_ () ;
static
...
ATSstaticdec()
ats_void_type
prerr_interror_02052_ () {
/* local vardec */
// ATSlocal_void (tmp15) ;
// ATSlocal_void (tmp16) ;
// ATSlocal_void (tmp17) ;

__ats_lab_prerr_interror_02052_:
/* tmp16 = */ atspre_prerr_string (ATSstrcst("INTERROR(")) ;
/* tmp17 = */ prerr_FILENAME_02051_ () ;
/* tmp15 = */ atspre_prerr_string (ATSstrcst(")")) ;
return /* (tmp15) */ ;
} /* end of [prerr_interror_02052_] */
