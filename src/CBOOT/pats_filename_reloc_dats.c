...
tmp3 = ptr0_get_01701_ats_char_type (tmp5) ;
do {
/* branch: __ats_lab_0 */
__ats_lab_0_0:
__ats_lab_0_1:
...
tmp19 = ptr0_get_01701_ats_char_type (arg0) ;
...
tmp17 = ptr0_get_01701_ats_char_type (ats_castfn_mac(ats_ptr_type, arg0)) ;
do {
/* branch: __ats_lab_6 */
__ats_lab_6_0:
__ats_lab_6_1:
...
/*
// /home/hwxi/research/Postiats/git/src/pats_filename_reloc.dats: 4931(line=206, offs=3) -- 5682(line=237, offs=4)
*/
ATSglobaldec()
ats_ptr_type
...
/* tmp41 = */ atspre_print_string (ATSstrcst("pkgsrcname_relocatize: given2 = ")) ;
/* tmp42 = */ atspre_print_string (ats_castfn_mac(ats_ptr_type, tmp39)) ;
/* tmp43 = */ atspre_print_newline () ;
tmp44 = _2home_2hwxi_2research_2Postiats_2git_2src_2pats_filename_reloc_2edats__pkgtarget_eval (ats_castfn_mac(ats_ptr_type, tmp39)) ;
/* tmp45 = */ atspre_print_string (ATSstrcst("pkgsrcname_relocatize: given2 = ")) ;
/* tmp46 = */ atspre_print_string (tmp44) ;
