...
ATSextern_fun(ats_void_type, _2home_2hwxi_2Research_2ATS_2dPostiats_2src_2pats_tokbuf_2esats__tokbuf_initialize_filp) (ats_ref_type, ats_ptr_type) ;
ATSextern_fun(ats_void_type, _2home_2hwxi_2Research_2ATS_2dPostiats_2src_2pats_tokbuf_2esats__tokbuf_initialize_getc) (ats_ref_type, ats_clo_ptr_type) ;
ATSextern_fun(ats_void_type, _2home_2hwxi_2Research_2ATS_2dPostiats_2src_2pats_tokbuf_2esats__tokbuf_initialize_string) (ats_ref_type, ats_ptr_type) ;
ATSextern_fun(ats_void_type, _2home_2hwxi_2Research_2ATS_2dPostiats_2src_2pats_tokbuf_2esats__tokbuf_uninitialize) (ats_ref_type) ;
...
/*
// /home/hwxi/Research/ATS-Postiats/src/pats_parsing.dats: 1781(line=62, offs=3) -- 2081(line=71, offs=4)
*/
ATSglobaldec()
ats_ptr_type
...
/* tmp2 = */ _2home_2hwxi_2Research_2ATS_2dPostiats_2src_2pats_tokbuf_2esats__tokbuf_initialize_string ((&tmp1), arg0) ;
/* ats_int_type tmp3 ; */
tmp3 = 0 ;
...
/* tmp6 = */ _2home_2hwxi_2Research_2ATS_2dPostiats_2src_2pats_tokbuf_2esats__tokbuf_uninitialize ((&tmp1)) ;
...
/*
// /home/hwxi/Research/ATS-Postiats/src/pats_parsing.dats: 2180(line=77, offs=3) -- 2613(line=95, offs=4)
*/
ATSglobaldec()
ats_ptr_type
...
/*
// /home/hwxi/Research/ATS-Postiats/src/pats_parsing.dats: 2799(line=105, offs=11) -- 2840(line=105, offs=52)
*/
ATSstaticdec()
ats_int_type
...
/*
// /home/hwxi/Research/ATS-Postiats/src/pats_parsing.dats: 2706(line=101, offs=3) -- 2934(line=108, offs=2)
*/
ATSglobaldec()
ats_ptr_type
...
/* tmp21 = */ _2home_2hwxi_2Research_2ATS_2dPostiats_2src_2pats_tokbuf_2esats__tokbuf_initialize_getc ((&tmp20), __ats_fun_3_closure_make (arg1)) ;
tmp23 = _2home_2hwxi_2Research_2ATS_2dPostiats_2src_2pats_parsing_2esats__parse_from_tokbuf_toplevel (arg0, (&tmp20)) ;
/* tmp24 = */ _2home_2hwxi_2Research_2ATS_2dPostiats_2src_2pats_tokbuf_2esats__tokbuf_uninitialize ((&tmp20)) ;
tmp19 = tmp23 ;
return (tmp19) ;
} /* end of [_2home_2hwxi_2Research_2ATS_2dPostiats_2src_2pats_parsing_2esats__parse_from_fileref_toplevel] */

/*
// /home/hwxi/Research/ATS-Postiats/src/pats_parsing.dats: 3015(line=112, offs=3) -- 3075(line=113, offs=50)
*/
ATSglobaldec()
ats_ptr_type
...
tmp25 = _2home_2hwxi_2Research_2ATS_2dPostiats_2src_2pats_parsing_2esats__parse_from_fileref_toplevel (arg0, stdin) ;
return (tmp25) ;
} /* end of [_2home_2hwxi_2Research_2ATS_2dPostiats_2src_2pats_parsing_2esats__parse_from_stdin_toplevel] */

/*
// /home/hwxi/Research/ATS-Postiats/src/pats_parsing.dats: 3178(line=120, offs=3) -- 3711(line=150, offs=4)
*/
ATSglobaldec()
ats_ptr_type
...
tmp28 = _2home_2hwxi_2Research_2ATS_2dPostiats_2src_2pats_filename_2esats__filename_get_fullname (arg1) ;
tmp29 = _2home_2hwxi_2Research_2ATS_2dPostiats_2src_2pats_symbol_2esats__symbol_get_name (tmp28) ;
tmp30 = atslib_fopen_exn (tmp29, "r") ;
tmp31 = ats_selsin_mac(tmp30, atslab_1) ;
/* tmp32 = */ _2home_2hwxi_2Research_2ATS_2dPostiats_2src_2pats_tokbuf_2esats__tokbuf_initialize_filp ((&tmp27), tmp31) ;
/* tmp33 = */ _2home_2hwxi_2Research_2ATS_2dPostiats_2src_2pats_filename_2esats__the_filenamelst_push (arg1) ;
/* tmp34 = ats_selsin_mac(tmp33, atslab_1) */ ;
tmp35 = _2home_2hwxi_2Research_2ATS_2dPostiats_2src_2pats_parsing_2esats__parse_from_tokbuf_toplevel (arg0, (&tmp27)) ;
/* tmp36 = */ _2home_2hwxi_2Research_2ATS_2dPostiats_2src_2pats_filename_2esats__the_filenamelst_pop () ;
/* tmp37 = */ _2home_2hwxi_2Research_2ATS_2dPostiats_2src_2pats_tokbuf_2esats__tokbuf_uninitialize ((&tmp27)) ;
tmp26 = tmp35 ;
return (tmp26) ;
} /* end of [_2home_2hwxi_2Research_2ATS_2dPostiats_2src_2pats_parsing_2esats__parse_from_filename_toplevel] */

/*
// /home/hwxi/Research/ATS-Postiats/src/pats_parsing.dats: 3818(line=156, offs=3) -- 3973(line=165, offs=4)
*/
ATSglobaldec()
ats_ptr_type
...
tmp39 = _2home_2hwxi_2Research_2ATS_2dPostiats_2src_2pats_filename_2esats__filename_isnot_dummy (arg1) ;
if (tmp39) {
tmp38 = _2home_2hwxi_2Research_2ATS_2dPostiats_2src_2pats_parsing_2esats__parse_from_filename_toplevel (arg0, arg1) ;
} else {
...
/*
// /home/hwxi/Research/ATS-Postiats/src/pats_parsing.dats: 4079(line=171, offs=3) -- 4972(line=212, offs=4)
*/
ATSglobaldec()
ats_ptr_type
...
tmp41 = _2home_2hwxi_2Research_2ATS_2dPostiats_2src_2pats_filename_2esats__filenameopt_make_local (arg1) ;
do {
/* branch: __ats_lab_0 */
__ats_lab_0_0:
...
tmp43 = _2home_2hwxi_2Research_2ATS_2dPostiats_2src_2pats_parsing_2esats__parse_from_filename_toplevel (arg0, tmp42) ;
/* tmp44 = */ _2home_2hwxi_2Research_2ATS_2dPostiats_2src_2pats_filename_2esats__the_filenamelst_ppush (tmp42) ;
tmp40 = tmp43 ;
break ;
...
((ats_exn_ptr_type)tmp51)->tag = _2home_2hwxi_2Research_2ATS_2dPostiats_2src_2pats_error_2esats__PATSOPT_FILENONE_EXN.tag ;
((ats_exn_ptr_type)tmp51)->name = _2home_2hwxi_2Research_2ATS_2dPostiats_2src_2pats_error_2esats__PATSOPT_FILENONE_EXN.name ;
