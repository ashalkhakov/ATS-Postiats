...
ATSextern_fun(ats_void_type, _2home_2hwxi_2Research_2Postiats_2git_2src_2pats_tokbuf_2esats__tokbuf_initize_filp) (ats_ref_type, ats_ptr_type) ;
ATSextern_fun(ats_void_type, _2home_2hwxi_2Research_2Postiats_2git_2src_2pats_tokbuf_2esats__tokbuf_initize_getc) (ats_ref_type, ats_clo_ptr_type) ;
ATSextern_fun(ats_void_type, _2home_2hwxi_2Research_2Postiats_2git_2src_2pats_tokbuf_2esats__tokbuf_initize_string) (ats_ref_type, ats_ptr_type) ;
ATSextern_fun(ats_void_type, _2home_2hwxi_2Research_2Postiats_2git_2src_2pats_tokbuf_2esats__tokbuf_uninitize) (ats_ref_type) ;
...
/*
// /home/hwxi/Research/Postiats/git/src/pats_parsing.dats: 1781(line=62, offs=3) -- 2086(line=72, offs=4)
*/
ATSglobaldec()
ats_ptr_type
_2home_2hwxi_2Research_2Postiats_2git_2src_2pats_parsing_2esats__parse_from_string_parser (ats_ptr_type arg0, ats_ptr_type arg1) {
/* local vardec */
...
__ats_lab__2home_2hwxi_2Research_2Postiats_2git_2src_2pats_parsing_2esats__parse_from_string_parser:
/* pats_tokbuf_struct tmp1 ; */
/* tmp2 = */ _2home_2hwxi_2Research_2Postiats_2git_2src_2pats_tokbuf_2esats__tokbuf_initize_string ((&tmp1), arg0) ;
/* ats_int_type tmp3 ; */
tmp3 = 0 ;
...
/* tmp6 = */ _2home_2hwxi_2Research_2Postiats_2git_2src_2pats_tokbuf_2esats__tokbuf_uninitize ((&tmp1)) ;
...
return (tmp0) ;
} /* end of [_2home_2hwxi_2Research_2Postiats_2git_2src_2pats_parsing_2esats__parse_from_string_parser] */

/*
// /home/hwxi/Research/Postiats/git/src/pats_parsing.dats: 2185(line=78, offs=3) -- 2624(line=98, offs=4)
*/
ATSglobaldec()
ats_ptr_type
...
/*
// /home/hwxi/Research/Postiats/git/src/pats_parsing.dats: 2768(line=107, offs=3) -- 2956(line=115, offs=2)
*/
ATSglobaldec()
ats_ptr_type
...
/* tmp21 = */ _2home_2hwxi_2Research_2Postiats_2git_2src_2pats_tokbuf_2esats__tokbuf_initize_string ((&tmp20), arg1) ;
tmp22 = _2home_2hwxi_2Research_2Postiats_2git_2src_2pats_parsing_2esats__parse_from_tokbuf_toplevel (arg0, (&tmp20)) ;
/* tmp23 = */ _2home_2hwxi_2Research_2Postiats_2git_2src_2pats_tokbuf_2esats__tokbuf_uninitize ((&tmp20)) ;
tmp19 = tmp22 ;
return (tmp19) ;
} /* end of [libatsopt_parse_from_string_toplevel] */

/*
// /home/hwxi/Research/Postiats/git/src/pats_parsing.dats: 3057(line=121, offs=3) -- 3117(line=122, offs=50)
*/
ATSglobaldec()
ats_ptr_type
...
tmp24 = _2home_2hwxi_2Research_2Postiats_2git_2src_2pats_parsing_2esats__parse_from_fileref_toplevel (arg0, stdin) ;
return (tmp24) ;
} /* end of [_2home_2hwxi_2Research_2Postiats_2git_2src_2pats_parsing_2esats__parse_from_stdin_toplevel] */

/*
// /home/hwxi/Research/Postiats/git/src/pats_parsing.dats: 3286(line=134, offs=9) -- 3327(line=134, offs=50)
*/
ATSstaticdec()
ats_int_type
...
/*
// /home/hwxi/Research/Postiats/git/src/pats_parsing.dats: 3198(line=127, offs=3) -- 3420(line=139, offs=2)
*/
ATSglobaldec()
ats_ptr_type
...
/* tmp27 = */ _2home_2hwxi_2Research_2Postiats_2git_2src_2pats_tokbuf_2esats__tokbuf_initize_getc ((&tmp26), __ats_fun_5_closure_make (arg1)) ;
tmp29 = _2home_2hwxi_2Research_2Postiats_2git_2src_2pats_parsing_2esats__parse_from_tokbuf_toplevel (arg0, (&tmp26)) ;
/* tmp30 = */ _2home_2hwxi_2Research_2Postiats_2git_2src_2pats_tokbuf_2esats__tokbuf_uninitize ((&tmp26)) ;
tmp25 = tmp29 ;
return (tmp25) ;
} /* end of [_2home_2hwxi_2Research_2Postiats_2git_2src_2pats_parsing_2esats__parse_from_fileref_toplevel] */

/*
// /home/hwxi/Research/Postiats/git/src/pats_parsing.dats: 3525(line=145, offs=3) -- 4052(line=175, offs=4)
*/
ATSglobaldec()
ats_ptr_type
...
tmp33 = _2home_2hwxi_2Research_2Postiats_2git_2src_2pats_filename_2esats__filename_get_fullname (arg1) ;
tmp34 = _2home_2hwxi_2Research_2Postiats_2git_2src_2pats_symbol_2esats__symbol_get_name (tmp33) ;
tmp35 = atslib_fopen_exn (tmp34, "r") ;
tmp36 = ats_selsin_mac(tmp35, atslab_1) ;
/* tmp37 = */ _2home_2hwxi_2Research_2Postiats_2git_2src_2pats_tokbuf_2esats__tokbuf_initize_filp ((&tmp32), tmp36) ;
/* tmp38 = */ _2home_2hwxi_2Research_2Postiats_2git_2src_2pats_filename_2esats__the_filenamelst_push (arg1) ;
/* tmp39 = ats_selsin_mac(tmp38, atslab_1) */ ;
tmp40 = _2home_2hwxi_2Research_2Postiats_2git_2src_2pats_parsing_2esats__parse_from_tokbuf_toplevel (arg0, (&tmp32)) ;
/* tmp41 = */ _2home_2hwxi_2Research_2Postiats_2git_2src_2pats_filename_2esats__the_filenamelst_pop () ;
/* tmp42 = */ _2home_2hwxi_2Research_2Postiats_2git_2src_2pats_tokbuf_2esats__tokbuf_uninitize ((&tmp32)) ;
tmp31 = tmp40 ;
return (tmp31) ;
} /* end of [_2home_2hwxi_2Research_2Postiats_2git_2src_2pats_parsing_2esats__parse_from_filename_toplevel] */

/*
// /home/hwxi/Research/Postiats/git/src/pats_parsing.dats: 4159(line=181, offs=3) -- 4318(line=192, offs=4)
*/
ATSglobaldec()
ats_ptr_type
...
tmp44 = _2home_2hwxi_2Research_2Postiats_2git_2src_2pats_filename_2esats__filename_isnot_dummy (arg1) ;
if (tmp44) {
tmp43 = _2home_2hwxi_2Research_2Postiats_2git_2src_2pats_parsing_2esats__parse_from_filename_toplevel (arg0, arg1) ;
} else {
...
/*
// /home/hwxi/Research/Postiats/git/src/pats_parsing.dats: 4424(line=198, offs=3) -- 5343(line=242, offs=4)
*/
ATSglobaldec()
ats_ptr_type
...
tmp46 = _2home_2hwxi_2Research_2Postiats_2git_2src_2pats_filename_2esats__filenameopt_make_local (arg1) ;
do {
/* branch: __ats_lab_0 */
__ats_lab_0_0:
if (tmp46 == (ats_sum_ptr_type)0) { goto __ats_lab_1_0 ; }
__ats_lab_0_1:
tmp47 = ats_caselptrlab_mac(anairiats_sum_0, tmp46, atslab_0) ;
ATS_FREE(tmp46) ;
ats_ptrget_mac(ats_ptr_type, arg2) = tmp47 ;
tmp48 = _2home_2hwxi_2Research_2Postiats_2git_2src_2pats_parsing_2esats__parse_from_filename_toplevel (arg0, tmp47) ;
/* tmp49 = */ _2home_2hwxi_2Research_2Postiats_2git_2src_2pats_filename_2esats__the_filenamelst_ppush (tmp47) ;
tmp45 = tmp48 ;
break ;
...
/* tmp50 = */ atspre_prerr_string (ATSstrcst("patsopt: error(0)")) ;
/* tmp51 = */ atspre_prerr_string (ATSstrcst(": the given file [")) ;
/* tmp52 = */ atspre_prerr_string (arg1) ;
/* tmp53 = */ atspre_prerr_string (ATSstrcst("] cannot be accessed.")) ;
/* tmp54 = */ atspre_prerr_newline () ;
tmp56 = ATS_MALLOC(sizeof(anairiats_sum_1)) ;
((ats_exn_ptr_type)tmp56)->tag = _2home_2hwxi_2Research_2Postiats_2git_2src_2pats_error_2esats__PATSOPT_FILENONE_EXN.tag ;
((ats_exn_ptr_type)tmp56)->name = _2home_2hwxi_2Research_2Postiats_2git_2src_2pats_error_2esats__PATSOPT_FILENONE_EXN.name ;
ats_selptrset_mac(anairiats_sum_1, tmp56, atslab_0, arg1) ;
/* tmp55 = */ ats_raise_exn (tmp56) ;
