...
static
ats_void_type prerr_FILENAME_01876_ () ;
static
...
static
ats_void_type prerr_error1_loc_01879_ (ats_ptr_type arg0) ;
static
...
ATSstaticdec()
ats_void_type
prerr_FILENAME_01876_ () {
/* local vardec */
// ATSlocal_void (tmp0) ;

__ats_lab_prerr_FILENAME_01876_:
/* tmp0 = */ atspre_prerr_string (ATSstrcst("pats_trans1_staexp")) ;
return /* (tmp0) */ ;
} /* end of [prerr_FILENAME_01876_] */
...
ATSstaticdec()
ats_void_type
prerr_error1_loc_01879_ (ats_ptr_type arg0) {
/* local vardec */
// ATSlocal_void (tmp21) ;
// ATSlocal_void (tmp22) ;

__ats_lab_prerr_error1_loc_01879_:
...
return /* (tmp21) */ ;
} /* end of [prerr_error1_loc_01879_] */
...
/* tmp20 = */ prerr_error1_loc_01879_ (tmp23) ;
